...
<body>
    ...
    <div class="menu">
        ...
        <p class="elem_menu historique"><a href="historique.php"><img src="..\IMG\arrowright.png">Mon Profil </a><span style="font-size: 0.7em;">(historique des questions)</span></p><br><br>
    ...
    <div class="presentation_container">
        <p class="welcome">Liste des questions</p>
