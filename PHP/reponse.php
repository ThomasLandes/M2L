...
if ($submit) {
    ...
    $idfaq = $_POST['id'];
    echo " ".$id;
    $sql = "UPDATE faq SET reponse=:reponse WHERE idfaq=:id";
    $params = array(
        ":id" => $idfaq,
        ":reponse" => $reponse,
    );
    ...
    $sql = "select question, idfaq from faq where idfaq=:id";
    $params = array(
        ":id" => $idfaq
    );
    try {
        ...
        <div class="contenu">
            ...
            <div class="login">
                <form class="login-container" method="POST">
                    ...
                    <p> <textarea name="reponse" id="Add" rows="5"></textarea></p>
                    <p><input type="hidden" name="id" value="<?php echo $id; ?>"></p>
                    <p><input type="submit" name="submit" value="Répondre"></p>
                </form>
            </div>
        </div>
    </div>
